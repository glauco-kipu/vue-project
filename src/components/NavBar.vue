...
onMounted(() => {
    const $modalTeleportElement = document.querySelector('#modal-navbar-info');
...
<template>
      ...
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        >
          ...
          <button
            ...
            data-modal-hide="modal-navbar-info"
          >
            <svg
              class="w-3 h-3"
              aria-hidden="true"
        ...
        <div class="p-4 md:p-5 space-y-4">
          <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
            Sorry, but we are not ready yet to create new elements. We are working on it.
          </p>
        </div>
        <!-- Modal footer -->
        <div class="grid justify-items-end  p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
          <button
            data-modal-hide="modal-navbar-info"
            type="button"
  ...
  >
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
      ...
      >
        <svg
          class="w-5 h-5 mb-1 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          viewBox="0 0 20 20"
          :style="{ 'color': $route.path === '/' ? '#3B82F6' : '#6B7280' }"
        >
          <path
      ...
      <button
        ...
        :class="{ 'bg-gray-50': $route.path === '/counter' }"
      ...
      >
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 20 20"
          :class="{ 'color': $route.path === '/counter' ? '#3B82F6' : '#6B7280' }"
        >
          <path
            fill="currentColor"
      ...
      <div class="flex items-center justify-center">
        <button
          data-modal-toggle="modal-navbar-info"
          data-modal-target="modal-navbar-info"
      ...
      <button
        ...
        type="button"
        class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group"
        :class="{ 'bg-gray-50': $route.path === '/teleport' }"
        @click="router.push('/teleport')"
      >
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 24 24"
          :style="{ 'color': $route.path === '/teleport' ? '#3B82F6' : '#6B7280' }"
        >
          <path
      ...
      <button
        ...
        :class="{ 'bg-gray-50': $route.path === '/store' }"
        @click="router.push({ path: '/store', replace: true })"
      >
        <svg
          class="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          ...
          fill="currentColor"
          viewBox="0 0 24 24"
          :style="{ 'color': $route.path === '/store' ? '#3B82F6' : '#6B7280' }"
        >
          <path
            fill-rule="evenodd"
        ...
        <span class="sr-only">Store <small>(Pinia)</small></span>
      </button>
      <div
        id="tooltip-profile"
        role="tooltip"
